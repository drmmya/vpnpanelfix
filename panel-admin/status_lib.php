...
function ms_local_status(){
  ...
  return [
    ...
    'v2ray'=>['installed'=>proto_enabled('V2RAY'),'running'=>ms_svc_running('v2ray'),'port'=>$v2port,'security'=>$v2env['V2_SECURITY']??'reality','flow'=>$v2env['V2_FLOW']??'xtls-rprx-vision','active'=>count($v2),'sessions'=>array_slice($v2,0,50)],
